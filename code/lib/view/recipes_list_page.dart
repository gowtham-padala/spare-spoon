...
class _RecipeCardState extends State<RecipeCard> {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      color: Colors.grey[700], // Set the background color
      child: ListTile(
        title: Text(
          widget.name,
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                // Add code to delete the recipe from Firestore here
                // You may need to pass some identifier or key to identify which recipe to delete.
                // After deleting, you can Navigator.of(context).pop() to close the dialog.
                Navigator.of(context).pop();
              },
            ),
          ],
